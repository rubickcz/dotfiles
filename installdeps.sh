...
sudo pacman -Sy --needed  alsa-utils autocutsel base-devel bash bash-completion chromium feh freetype2 dina-font dmenu dunst gnupg gsimplecal gtk-engines gvim i3 libnotify mc numlockx pass python-netifaces python-psutil python-virtualenvwrapper rxvt-unicode ttf-dejavu udevil xorg xorg-xinit xorg-xinput xorg-xrandr xxkb wget
